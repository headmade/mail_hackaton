...
class CollagesControllerTest < ActionController::TestCase
  ...
  test "should create collage" do
    assert_difference('Collage.count') do
      post :create, collage: { image: @collage.image, photos: @collage.photos, title: @collage.title, user_id: @collage.user_id }
    end
  ...
  test "should update collage" do
    patch :update, id: @collage, collage: { image: @collage.image, photos: @collage.photos, title: @collage.title, user_id: @collage.user_id }
    assert_redirected_to collage_path(assigns(:collage))
  end
